...
@section('noi_dung')
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="bread"><span><a href="/">Home</a></span> / <span>Danh mục</span> / <span>{{$danhmuc->ten_danh_muc}}</span></p>
                </div>
            </div>
        </div>
    </div>
    <input type="number" value="{{$danhmuc->id}}" id="id_danh_muc" hidden>
    <div class="breadcrumbs-two">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="breadcrumbs-img" style="background-image: url({{$danhmuc->hinh_anh}});">
                        <h2 class="text-white">{{$danhmuc->ten_danh_muc}}</h2>
                    </div>
                    ...
                    <div class="col-md-3 col-lg-3 mb-4 text-center">
                        <div class="product-entry border">
                            ...
                            <div class="desc">
                                ...
                                <span class="price text-danger"><b>@{{formatNumber(v.gia)}}  ₫</b></span>
                            </div>
                        </div>
                    </div>
                </template>
        ...
        new Vue({
            ...
            methods: {
                loadData(page = 1) { // Truyền thêm trang (mặc định là 1)
                    ...
                    axios
                        .post('{{ Route('DanhMucDataProduct') }}', payload, {
                            page: page
                        })
                        .then((res) => {
