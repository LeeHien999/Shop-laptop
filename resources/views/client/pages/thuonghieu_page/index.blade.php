...
@section('noi_dung')
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="bread"><span><a href="/">Home</a></span> / <span>Danh mục</span> / <span>{{$thuonghieu->ten_thuong_hieu}}</span></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="breadcrumbs-two">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="breadcrumbs-img" style="background-image: url({{$thuonghieu->hinh_anh}});">
                        <h2 class="text-white">{{$thuonghieu->ten_thuong_hieu}}</h2>
                    </div>
