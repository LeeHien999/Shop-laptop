                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="cart-detail">
                                ...
                                <ul>
                                    <li>
                                        <span>Subtotal</span> <span>@{{ formatNumber(tong) }} ₫</span>
                                        <ul v-for="(v, k) in List_prod">
                                            <li><span>@{{ v.so_luong }} x @{{ v.ten_san_pham }} :
                                                    <b>@{{ v.ten_mau_sac }} - @{{ v.ten_cau_hinh }}</b></span>
                                                <span>@{{ formatNumber(sumOne(v.gia, v.so_luong)) }} ₫</span></li>
                                        </ul>
                                    </li>
                                    <li><span>Shipping</span> <span>@{{ formatNumber(phiship) }} ₫</span></li>
                                    <li><span>Order Total</span> <span>@{{ formatNumber(TongVShip) }} ₫</span></li>
                                </ul>
                            </div>
                        </div>
